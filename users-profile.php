        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              <a href="update_profile.php?img_id=<?php echo $_SESSION['profile']?>" role="button"><img src="media/<?php echo $_SESSION['profile']?>" width="150px" height="120px" alt="Profile" class="rounded-circle"></a>
              ...
              <div class="social-links mt-2">
                ...
                <a href="https://web.facebook.com/login/?_rdc=1&_rdr" class="facebook"><i class="bi bi-facebook"></i></a>
                  ...
                  <form method="POST" enctype="multipart/form-data">
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <img src="media/<?php echo $_SESSION['profile']?>" alt="Profile" name="profile">
                        <div class="pt-2">
