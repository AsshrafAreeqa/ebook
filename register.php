  ...
  if(isset($_FILES['profile'])){
    $errors = array();
            ...
            if(empty($errors)==true){
                ...
                echo "<script>window.location.href='http://localhost:82/admin/register.php';</script>";
                die();
            }
        }

        $insert_sql = "INSERT INTO admin(a_name,a_email,a_password,img)VALUES('{$username}','{$email}','{$password}','{$filename}')";
